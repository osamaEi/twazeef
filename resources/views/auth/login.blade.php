...
<head>
    ...
    *, *::before, *::after { 
    ...
    /* عند التركيز على حقل كلمة المرور */
    .form-input[type="password"]:focus ~ .password-toggle,
    .form-input[type="text"]:focus ~ .password-toggle {
        color: var(--primary-green);
    }
    ...
    <div class="auth-container">
        ...
        <div class="auth-brand-panel">
            <div class="brand-content">
                <h2 class="brand-title">{{ __('auth.login.brand_title') }}</h2>
                <p class="brand-description">
                    {{ __('auth.login.brand_description') }}
                </p>
            </div>
            ...
            <div class="brand-footer">
                <div class="brand-stats">
                    <div class="brand-stat">
                        ...
                        <div class="brand-stat-label">{{ __('auth.login.stats.companies') }}</div>
                    </div>
                    <div class="brand-stat">
                        <div class="brand-stat-value">24B</div>
                        <div class="brand-stat-label">{{ __('auth.login.stats.employment') }}</div>
                    </div>
                    <div class="brand-stat">
                        <div class="brand-stat-value">99.7%</div>
                        <div class="brand-stat-label">{{ __('auth.login.stats.satisfaction') }}</div>
                    </div>
                </div>
                <div class="brand-copyright">
                    {{ __('auth.login.copyright') }}
                </div>
            </div>
        </div>
        ...
        <div class="auth-form-panel">
            ...
            <form method="POST" action="{{ route('login') }}" novalidate>
                ...
                <div class="form-group">
                    <label class="form-label required" for="email">{{ __('auth.login.email_label') }}</label>
                    <div class="form-input-wrapper">
                        <input type="email" id="email" name="email" class="form-input @error('email') is-invalid @enderror" placeholder="{{ __('auth.login.email_placeholder') }}" value="{{ old('email') }}" required autofocus>
                ...
                <div class="form-group">
                    <label class="form-label required" for="password">{{ __('auth.login.password_label') }}</label>
                    <div class="form-input-wrapper">
                        <input type="password" id="password" name="password" class="form-input @error('password') is-invalid @enderror" placeholder="{{ __('auth.login.password_placeholder') }}" required>
                        <i class="form-input-icon fas fa-lock"></i>
                        <button type="button" class="password-toggle" aria-label="{{ __('auth.login.password_toggle_label') }}">
            ...
            <div class="login-link">
                <p>ليس لديك حساب؟ <a href="{{ route('employee.register') }}">إنشاء حساب</a></p>
            </div>
        </div>
    </div>
