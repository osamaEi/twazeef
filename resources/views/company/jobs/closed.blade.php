...
<div class="company-jobs-page">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p class="page-subtitle">إدارة الوظائف المغلقة والمنتهية</p>
        </div>
    ...
    <div class="stats-overview">
        <div class="stat-card info">
            ...
            <div class="stat-content">
                ...
                <p class="stat-label">إجمالي الوظائف المغلقة</p>
    ...
    <div class="jobs-section">
        <div class="section-header">
            <h2 class="section-title">الوظائف المغلقة</h2>
        ...
        <div class="jobs-grid">
            ...
            @empty
                <div class="empty-state">
                    ...
                    <p class="empty-text">لا توجد وظائف مغلقة حالياً</p>
