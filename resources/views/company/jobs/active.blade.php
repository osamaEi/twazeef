...
<div class="company-jobs-page">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p class="page-subtitle">إدارة الوظائف النشطة والمفتوحة للتقديم</p>
        </div>
    ...
    <div class="stats-overview">
        <div class="stat-card primary">
            ...
            <div class="stat-content">
                ...
                <p class="stat-label">إجمالي الوظائف النشطة</p>
    ...
    <div class="jobs-section">
        <div class="section-header">
            <h2 class="section-title">الوظائف النشطة</h2>
            <div class="section-actions">
                <a href="{{ route('company.jobs.paused') }}" class="btn btn-outline">الوظائف المعلقة</a>
        ...
        <div class="jobs-grid">
            ...
            @empty
                <div class="empty-state">
                    ...
                    <p class="empty-text">لا توجد وظائف نشطة حالياً</p>
