...
<div class="company-applications-page">
    ...
    <div class="page-header">
        <div class="header-content">
            ...
            <p class="page-subtitle">إدارة الطلبات التي تحتاج إلى مراجعة</p>
        </div>
        <div class="header-actions">
            <a href="{{ route('company.applications.index') }}" class="btn btn-outline">جميع الطلبات</a>
    ...
    <div class="applications-section">
        <div class="section-header">
            <h2 class="section-title">الطلبات قيد المراجعة</h2>
                ...
                <div class="application-card">
                    ...
                    <div class="application-footer">
                        <div class="application-actions">
                            ...
                            <button class="btn btn-sm btn-success" onclick="updateStatus({{ $application->id }}, 'shortlisted')">إضافة للقائمة المختصرة</button>
                            <button class="btn btn-sm btn-primary" onclick="updateStatus({{ $application->id }}, 'reviewed')">تمت المراجعة</button>
                        </div>
                    </div>
                </div>
            @empty
                <div class="empty-state">
                    ...
                    <p class="empty-text">لا توجد طلبات قيد المراجعة حالياً</p>
                </div>
            @endforelse
        </div>
...
<script>
function updateStatus(applicationId, status = null) {
