...
<div class="dashboard-content">
    ...
    <div class="content-header">
        <h1 class="content-title">{{ __('Admin Profile') }}</h1>
        <p class="content-subtitle">{{ __('Manage your administrative account and settings') }}</p>
    </div>
    ...
    <div class="content-body">
        <div class="max-w-7xl mx-auto space-y-6">
            ...
            <!-- Profile Actions -->
            <div class="profile-actions space-y-6">
